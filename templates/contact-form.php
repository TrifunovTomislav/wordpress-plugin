<form action="#" 
	...
	<div class="field-container">
		...
		<small class="field-msg error"
			   data-error="invalidName">Your Name is Required</small>
	</div>
	...
	<div class="field-container">
		<input type="email" 
               ...
               name="email" required>
		<small class="field-msg error"
			   data-error="invalidEmail">Your Email is Required</small>
	</div>
	...
	<div class="field-container">
		...
		<small class="field-msg error"
			   data-error="invalidMessage">A Message is Required</small>
	</div>
