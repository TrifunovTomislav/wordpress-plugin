<div class="wrap">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="<?php echo isset($_POST['edit_post']) ? 'active' : ''; ?>">
            <a href="#tab-2">
            <?php echo isset($_POST['edit_post']) ? 'Edit' : 'Add'; ?> CPT
            </a></li>
        <li><a href="#tab-3">Export</a></li>
    </ul>
    <div class="tab-content">
        <div id="tab-1" class="tab-panel <?php echo !isset($_POST['edit_post']) ? 'active' : ''; ?>">
            ...
            <?php
                ...
                foreach ($options as $option){
                    ...
                    settings_fields('sparky_plagin_cpt_settings');
                    echo '<input type="hidden" name="remove" value="' . $option['post_type'] . '" >';
                    submit_button('Delete', 'delete small', 'submit', false, array(
                        'onclick' => 'return confirm("Are you sure you want to delete this awsome post type u sick bastard? Why do you like killing stuff :(");'
                    ));
                    echo "</form></td></tr>";
        ...
        <div id="tab-2" class="tab-panel <?php echo isset($_POST['edit_post']) ? 'active' : ''; ?>">  
            <form method="post" action="options.php">
            <?php
                settings_fields('sparky_plagin_cpt_settings');
                do_settings_sections('sparky_cpt');
                submit_button();
            ?>
        </form>
        </div>
...
// Register Custom Post Type
 function registerCustomPostTypes(){
    ...
    $args = array(
        ...
        'description'           => __( '<?php echo $option['plural_name'] ?>' . ' i njihova namena', 'text_domain' ),
        'labels'                => $labels,
