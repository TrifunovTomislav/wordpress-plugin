document.addEventListener("DOMContentLoaded", function(e) {
  const showAuthBtn = document.getElementById("sparky-show-auth-form"),
    authContainer = document.getElementById("sparky-auth-container"),
    close = document.getElementById("sparky-auth-close"),
    authForm = document.getElementById("sparky-auth-form"),
  ...
  authForm.addEventListener("submit", e => {
    ...
    let data = {
      ...
      nonce: authForm.querySelector('[name="sparky_auth"]').value
    };
    // validate everything
  ...
  function resetMessages() {
    ...
    authForm.querySelector('[name="submit"]').value = "Loging";
