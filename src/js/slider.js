// global variables
const sliderView = document.querySelector(".sparky-slider--view > ul"),
  sliderViewSlides = document.querySelectorAll(".sparky-slider--view-slides"),
  arrowLeft = document.querySelector(".sparky-slider--arrows-left"),
  arrowRight = document.querySelector(".sparky-slider--arrows-right"),
...
const beforeSliding = i => {
  let isActiveItem = document.querySelector(
      ".sparky-slider--view-slides.is-active"
    ),
    ...
    sliderViewItems = document.querySelector(
      `.sparky-slider--view-slides:nth-child(${nextItem})`
    );

  // if nextItem is bigger than the # of slides
  if (nextItem > sliderLength) {
    sliderViewItems = document.querySelector(
      ".sparky-slider--view-slides:nth-child(1)"
    );
  }
  ...
  if (nextItem == 0) {
    sliderViewItems = document.querySelector(
      `.sparky-slider--view-slides:nth-child(${sliderLength})`
    );
  }
